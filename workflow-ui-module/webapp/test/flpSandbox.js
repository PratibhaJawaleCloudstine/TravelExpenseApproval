		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#travelexpensenspworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"travelexpensenspworkflowuimodule-display": {
								"semanticObject": "travelexpensenspworkflowuimodule",
								"action": "display",
								"description": "Travel Expense Approval Form",
								"title": "Travel Expense Approval Form",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=travelexpensensp.workflowuimodule",
									"url": sap.ui.require.toUrl("travelexpensensp/workflowuimodule")
								}
							}
						}
					}
